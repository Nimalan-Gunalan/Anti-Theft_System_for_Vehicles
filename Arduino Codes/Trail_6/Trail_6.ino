...
char phone[16];
char datetime[24];
char regnum[] = "+60169120193";//"+60169120636";//"+60173349706";
char keyword[] = "track";
char MESSAGE[300];
char lat[12];
char lon[12];
...
void setup() {
  ...
  delay(500);
  lcd.setCursor(0,0);lcd.setCursor(0,0);lcd.print("                   ");   lcd.setCursor(0,1);lcd.print("                   ");   lcd.setCursor(0,1);lcd.print("                   ");
  delay(500);*/
  ...
  while(!sim808.init())
  {
      ...
      lcd.setCursor(0,0);lcd.print("                   ");   lcd.setCursor(0,1);lcd.print("                   ");   lcd.setCursor(0,1);lcd.print("                   ");
  }
        ...
        if(chk==6)
        {
          ...
          while(true)
          {
            ...
            if (input=='3')
            {
              ...
              lcd.setCursor(0,0);lcd.print("Entered Option 3"); 
              delay(1000);
              ...
              /*
              int TN53=1;
              char displayWords7[]="Please type ID #";
              for(int d=0 ; d < sizeof(displayWords7)-1 ; d++ )
              {
                if(d<16)
                {
                  lcd.setCursor(d,0);lcd.print(displayWords7[d]);
                }
                else
                {
                  lcd.setCursor(0,0);
                  ...
                  //lcd.print("                   ");
                  lcd.setCursor(0,0);
                  for(int d1=TN53 ; d1 < sizeof(displayWords7) ; d1++ )
                  {
                    lcd.print(displayWords7[d1]);
                  }
                  TN53++;
                }
                delay(200);
...
{  
  ...
  if (p != FINGERPRINT_OK)  
  {
    ...
    Serial.print("Fingerprint confidence level "); 
